...
from solution4.workers.compute_gateway import ComputeTimeoutError, request_compute_sync
...
def _compute_outcome(
    *,
    ...
    transient invocation failure and retries the whole workflow. For Solution 4 we
