...
def test_grafana_assets_use_solution2_naming() -> None:
    dashboard = _project_root() / "monitoring/grafana/dashboards/solution2-overview.json"
    ...
    assert "folder: Solution2" in provisioning_text
