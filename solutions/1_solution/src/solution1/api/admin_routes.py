...
from solution1.api.contracts import AdminRoutesApp
from solution1.api.error_responses import api_error_response
from solution1.api.paths import COMPAT_ADMIN_CREDITS_PATH, V1_ADMIN_CREDITS_PATH
from solution1.constants import OAuthScope
from solution1.models.domain import AuthUser
from solution1.models.schemas import AdminCreditsRequest, AdminCreditsResponse
...
def register_admin_routes(app: FastAPI, app_module: AdminRoutesApp) -> None:
    ...
    async def admin_credits(
        ...
        if outcome is None:
            return api_error_response(status_code=404, code="NOT_FOUND", message="User not found")
