"""Typed protocol contracts for route modules that consume `solution0.app` symbols."""
...
class SystemRoutesApp(Protocol):
    ...
    async def _check_worker_connectivity(self, timeout_seconds: float = 1.0) -> bool: ...
