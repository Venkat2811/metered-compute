...
def test_prometheus_scrapes_api_and_compute_targets() -> None:
    ...
    assert 'job_name: "solution5-api"' in prometheus_config
    assert 'job_name: "solution5-compute"' in prometheus_config
...
def test_grafana_provisioning_and_dashboard_exist() -> None:
    ...
    dashboard_path = ROOT / "monitoring" / "grafana" / "dashboards" / "solution5-overview.json"
