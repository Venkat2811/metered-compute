...
from solution1.api.contracts import SystemRoutesApp
from solution1.api.paths import HEALTH_PATH, HIT_PATH, METRICS_PATH, READY_PATH
from solution1.models.schemas import ReadyResponse
...
def register_system_routes(app: FastAPI, app_module: SystemRoutesApp) -> None:
    ...
    async def health() -> dict[str, str]:
        ...
        return {"status": "ok", "service": "mc-solution1-api"}
    ...
    async def ready(request: Request) -> JSONResponse:
        ...
        worker_ready = await app_module._check_worker_connectivity(
            ...
            heartbeat_key=runtime.settings.stream_worker_heartbeat_key,
            timeout_seconds=runtime.settings.readiness_worker_timeout_seconds,
        )
