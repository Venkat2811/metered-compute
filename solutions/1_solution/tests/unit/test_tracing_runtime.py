...
import solution1.observability.tracing as tracing
...
def test_inject_current_trace_context_uses_propagator(
    ...
    monkeypatch.setattr("solution1.observability.tracing.propagate.inject", fake_inject)
...
def test_configure_process_tracing_is_noop_when_disabled() -> None:
    settings = SimpleNamespace(
        otel_enabled=False,
        otel_service_namespace="mc-solution1",
        app_env="dev",
