# RFC-0005: Data Ownership and Consistency

Parent: [RFC-0005 README](./README.md)

## Data ownership model

Solution 5 uses four stores with clear ownership boundaries. TigerBeetle is the source of truth for billing. Postgres is the source of truth for metadata. Redis is a cache. Restate is a workflow journal.
