...
USER1_API_KEY = os.getenv("ALICE_API_KEY", DEFAULT_ALICE_API_KEY)
USER2_API_KEY = os.getenv("BOB_API_KEY", DEFAULT_BOB_API_KEY)
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run deterministic load/stress scenarios for solution 2."
    )
