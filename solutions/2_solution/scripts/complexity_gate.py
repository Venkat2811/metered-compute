...
OVERRIDES: dict[str, Threshold] = {
    ...
    "src/solution2/app.py::create_app": Threshold(max_complexity=110, max_lines=700),
    # Submit orchestration is intentionally explicit in task_write_routes.
    "src/solution2/api/task_write_routes.py::register_task_write_routes": Threshold(
        max_complexity=110, max_lines=700
    ),
    "src/solution2/api/task_write_routes.py::submit_task": Threshold(
        max_complexity=55, max_lines=320
    ),
    "src/solution2/app.py::resolve_user_from_jwt_token": Threshold(
        max_complexity=45, max_lines=170
    ),
    "src/solution2/workers/worker.py::main_async": Threshold(max_complexity=35, max_lines=120),
}
