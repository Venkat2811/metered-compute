...
Status: in progress as of 2026-03-26. Billing wrapper, real outbox-relay process, real dispatcher bridge, worker completion seam, and worker model-runtime seam are green; RabbitMQ worker consume loop and end-to-end flow remain.
