...
if TYPE_CHECKING:
    ...
    DEFAULT_REDIS_TASKS_STREAM_KEY: str
    DEFAULT_REDIS_TASKS_STREAM_MAXLEN: int
...
def _default_values() -> dict[str, str | int]:
    ...
    return {
        ...
        "DEFAULT_REDIS_TASKS_STREAM_KEY": settings.redis_tasks_stream_key,
        "DEFAULT_REDIS_TASKS_STREAM_MAXLEN": settings.redis_tasks_stream_maxlen,
...
__all__ = [
    ...
    "DEFAULT_REDIS_TASKS_STREAM_KEY",
    "DEFAULT_REDIS_TASKS_STREAM_MAXLEN",
