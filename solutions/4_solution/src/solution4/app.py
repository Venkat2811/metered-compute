...
from solution4 import cache, metrics, repository
from solution4.billing import Billing
from solution4.logging import setup_logging
from solution4.settings import Settings
from solution4.workflows import _state as workflow_state
from solution4.workflows import task_service
...
def _derive_admin_topup_transfer_id(
    *,
    ...
    canonical = f"solution4-admin-topup|{admin_user_id}|{idempotency_key}"
