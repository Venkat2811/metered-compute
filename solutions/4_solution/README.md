# 4_solution: TigerBeetle + Restate Showcase
...
- `../../.0_agentic_engineering/0_rfcs/RFC-0004-5-solution-tb-restate-showcase/README.md`
...
Solution 4 intentionally supports a narrow compatibility slice:
...
- API: FastAPI (`src/solution4/app.py`)
- Compute: external FastAPI worker (`src/solution4/workers/compute_worker.py`)
- Billing: TigerBeetle double-entry engine (`src/solution4/billing.py`)
- Workflow: Restate durable control plane (`src/solution4/workflows.py`)
