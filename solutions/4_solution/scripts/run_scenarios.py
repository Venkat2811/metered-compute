#!/usr/bin/env python3
"""Scenario harness for Solution 4 — adapted from Sol 0's run_scenarios.py.
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run production-style scenario checks for solution 4.")
